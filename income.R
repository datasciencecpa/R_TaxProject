incomeUI <- function (id){
  ...
  tabPanel("Income",
    ...
    fluidRow(
      column(5, 
             numericInput(ns("ordinaryDividends_2018"), label = "Enter your ordinary dividends income: (Form 1099-DIV)",
                          value = 0, min=0),
             numericInput(ns("ordinaryDividends_2018"), label = "Enter your qualified dividends income: (Form 1099-DIV)",
                          value = 0, min=0)
      ),
      column(5, 
             numericInput(ns("ordinaryDividends_2017"), label = "Enter your ordinary dividends income: (Form 1099-DIV)",
                          value = 0, min=0),
             numericInput(ns("ordinaryDividends_2017"), label = "Enter your qualified dividends income: (Form 1099-DIV)",
                          value = 0, min=0)
      )      
    ),
    hr(),
    ...
    fluidRow(
      column(4, 
            numericInput(ns("IRADis_2018"), label = "Enter your taxable distribution IRA:", value = 0, min= 0),
            checkboxInput(ns("IRAException_2018"), label = "Check if you meet exception to 10% additional tax", value = FALSE)
      ),
      column(4, 
          numericInput(ns("IRADis_2017"), label = "Enter your taxable distribution IRA:", value = 0, min= 0),
